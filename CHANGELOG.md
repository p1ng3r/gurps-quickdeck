...
- Fixed QuickDeck modifier bucket status refreshes so the attack-card modifier anchor reads the native GURPS `modifierStack.modifierList` total live and returns to `+0` after bucket-clearing roll handoffs.
