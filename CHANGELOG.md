...
- Corrected Foundry-tested v0.6.1 proportions with a wider default window, a larger central selected-actor cockpit, a roomier framed roster, compact right-side tabs, and denser drawer list rows.
